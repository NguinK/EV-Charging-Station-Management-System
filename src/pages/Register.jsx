...
function RegisterPage() {
  return (
    <div className="flex min-h-screen items-center justify-center bg-[#798583] px-4 text-white">
      ...
      <Card className="mx-auto w-full max-w-2xl bg-[#020203]/95 !border-[#1c2320] !shadow-[0_30px_80px_rgba(8,19,15,0.55)]">
        <div className="flex flex-col gap-6">
          ...
          <div className="space-y-2">
            ...
            <Text className="text-sm leading-relaxed text-[#8f9a99]">
              ...
              <RouterLink
                to="/login"
                className="ml-1 font-medium transition-colors hover:text-[#b9ffda] !text-[#7cf69a]"
              >
                Sign in
              </RouterLink>
            </Text>
